...
@HippoEssentialsGenerated(internalName = "gogreen:account")
@Node(jcrType = "gogreen:account")
public class Account extends HippoCompound {

    public static final String TYPE = "gogreen:type";
    public static final String LINK = "gogreen:link";

    @HippoEssentialsGenerated(internalName = "gogreen:type")
